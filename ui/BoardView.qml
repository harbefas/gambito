...
RowLayout {
    ...
    Rectangle {
        ...
        visible: !app.zen
        Layout.preferredWidth: 390; Layout.fillHeight: true; radius: 14
        ...
        ColumnLayout {
            ...
            Loader { id: chatLoader; Layout.fillWidth: true; Layout.fillHeight: true; Layout.minimumHeight: 150; visible: active; active: app.chatVisible && !!app.game && app.game.online && !!app.game.color; sourceComponent: Component { ChatPanel { app: boardView.app; focusScope: boardView.focusScope } } }
            Rectangle {
                visible: !chatLoader.active
                Layout.fillWidth: true; Layout.fillHeight: true; Layout.minimumHeight: 150; radius: 10; color: app.bg; border.width: 1; border.color: app.line
                ListView {
                    id: moveList
