...
ColumnLayout {
    ...
    RowLayout {
        ...
        Layout.fillWidth: true; Layout.fillHeight: false; Layout.preferredHeight: 210; Layout.maximumHeight: 210; spacing: 12; visible: !!profile.perfKey
        ...
        Rectangle {
            ...
            Layout.preferredWidth: 300; Layout.fillHeight: true; radius: 10
            color: app.panel; border.width: 1; border.color: app.line
    ...
    // Tabs, plus filters for the history.
    RowLayout {
