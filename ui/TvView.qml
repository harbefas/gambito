...
Flickable {
    ...
    GridLayout {
        ...
        Item {
            Layout.fillWidth: true; Layout.fillHeight: !tvView.narrow
            Layout.preferredHeight: tvView.narrow ? Math.min(tvView.width, tvView.height * 0.62) + 64 : -1
            TvBoard {
                id: board
        ...
        Rectangle {
            ...
            visible: !app.zen
            Layout.preferredWidth: tvView.narrow ? -1 : 330; Layout.fillWidth: tvView.narrow
            Layout.fillHeight: !tvView.narrow; Layout.preferredHeight: tvView.narrow ? sidebar.implicitHeight + 28 : -1; radius: 14
            ...
            ColumnLayout {
                ...
                Rectangle {
                    ...
                    Layout.preferredHeight: tvView.narrow ? 200 : -1; radius: 10; color: app.bg; border.width: 1; border.color: app.line
                    ListView {
                        id: moveList
                        objectName: "tvMoves"
